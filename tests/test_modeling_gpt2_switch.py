...
class GPT2ModelTester:
    ...
    def create_and_check_lm_head_model(self, config, input_ids, input_mask, head_mask, token_type_ids, *args):
        model = GPT2SwitchLMHeadModel(config)
        model.to(torch_device)
        model.eval()
    ...
    def create_and_check_double_lm_head_model(
        ...
        model = GPT2SwitchDoubleHeadsModel(config)
        model.to(torch_device)
        model.eval()
...
class GPT2ModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    def test_model_from_pretrained(self):
        for model_name in GPT2_PRETRAINED_MODEL_ARCHIVE_LIST[:1]:
            model = GPT2SwitchModel.from_pretrained(model_name)
...
class GPT2ModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_lm_generate_gpt2(self):
        model = GPT2SwitchLMHeadModel.from_pretrained("gpt2")
        model.to(torch_device)
    ...
    def test_lm_generate_distilgpt2(self):
        model = GPT2SwitchLMHeadModel.from_pretrained("distilgpt2")
        model.to(torch_device)
